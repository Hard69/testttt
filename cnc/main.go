...
const DatabasePass string   = "kaunas1234"
const DatabaseTable string  = "x_dbase"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
    tel, err := net.Listen("tcp", "34.116.246.40:60195")
    if err != nil {
        fmt.Println(err)
        return
    }

    api, err := net.Listen("tcp", "34.116.246.40:44115")
    if err != nil {
        fmt.Println(err)
        return
    }
